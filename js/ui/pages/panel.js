...
export function renderPanelPage(container, cultivation, plan, helpers) {
  const { card, escape, date, latest, plantFor, activeAlerts, formatDecimal, calendarWeek } = helpers;
